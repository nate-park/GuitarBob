...
/** Luna – purple cat guitar buddy. Same poses as Bob. */
const LUNA_POSES = {
  default: (
    <g className="animate-bounce-soft">
      <circle cx="80" cy="100" r="52" fill="#CE82FF" stroke="#A855F7" strokeWidth="4"/>
      <circle cx="80" cy="100" r="44" fill="#E9D5FF" opacity="0.4"/>
      {/* Cat ears */}
      <path d="M35 55 L55 85 L45 88 Z" fill="#CE82FF" stroke="#A855F7" strokeWidth="2"/>
      <path d="M125 55 L105 85 L115 88 Z" fill="#CE82FF" stroke="#A855F7" strokeWidth="2"/>
      ...
      <ellipse cx="128" cy="75" rx="14" ry="18" fill="#CE82FF" stroke="#A855F7" strokeWidth="2" transform="rotate(-20 128 75)"/>
      <path d="M120 68 L136 68 L136 82 L120 82" stroke="#A855F7" strokeWidth="2" fill="none" transform="rotate(-20 128 75)"/>
      <rect x="55" y="125" width="50" height="28" rx="4" fill="#8B4513" stroke="#654321" strokeWidth="2"/>
      <circle cx="80" cy="139" r="8" fill="#2d2d2d"/>
      <line x1="80" y1="115" x2="80" y2="125" stroke="#654321" strokeWidth="3"/>
    </g>
  ),
  happy: (
    <g className="animate-bounce-soft">
  ...
  thinking: (
    <g>
      ...
      <ellipse cx="45" cy="105" rx="12" ry="16" fill="#CE82FF" stroke="#A855F7" strokeWidth="2" transform="rotate(-30 45 105)"/>
      <rect x="55" y="125" width="50" height="28" rx="4" fill="#8B4513" stroke="#654321" strokeWidth="2"/>
      <circle cx="80" cy="139" r="8" fill="#2d2d2d"/>
      <line x1="80" y1="115" x2="80" y2="125" stroke="#654321" strokeWidth="3"/>
  ...
  teaching: (
    <g className="animate-wiggle">
      ...
      <line x1="80" y1="85" x2="120" y2="60" stroke="#A855F7" strokeWidth="10" strokeLinecap="round"/>
      <circle cx="125" cy="58" r="8" fill="#CE82FF" stroke="#A855F7" strokeWidth="2"/>
      <rect x="55" y="125" width="50" height="28" rx="4" fill="#8B4513" stroke="#654321" strokeWidth="2"/>
      <circle cx="80" cy="139" r="8" fill="#2d2d2d"/>
      <line x1="80" y1="115" x2="80" y2="125" stroke="#654321" strokeWidth="3"/>
    </g>
...
export default function Luna({ pose = 'default', size = 200, className = '' }) {
  return (
    <svg viewBox="0 0 160 160" width={size} height={size} className={`inline-block ${className}`} aria-hidden>
      {LUNA_POSES[pose] || LUNA_POSES.default}
    </svg>
  );
}
