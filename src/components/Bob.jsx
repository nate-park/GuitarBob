...
/**
 * Bob the friendly AI guitar tutor – Duolingo-owl style mascot.
 * Poses: default (wave), happy, thinking, teaching, listening, sad
 */
const BOB_POSES = {
  default: (
    <g className="animate-bounce-soft">
      <circle cx="80" cy="100" r="52" fill="#58CC02" stroke="#46A302" strokeWidth="4"/>
      <circle cx="80" cy="100" r="44" fill="#89E219" opacity="0.3"/>
      ...
      {/* Wave hand */}
      <ellipse cx="128" cy="75" rx="14" ry="18" fill="#58CC02" stroke="#46A302" strokeWidth="2" transform="rotate(-20 128 75)"/>
      <path d="M120 68 L136 68 L136 82 L120 82" stroke="#46A302" strokeWidth="2" fill="none" transform="rotate(-20 128 75)"/>
      {/* Little guitar */}
  ...
  thinking: (
    <g>
      ...
      {/* Hand on chin */}
      <ellipse cx="45" cy="105" rx="12" ry="16" fill="#58CC02" stroke="#46A302" strokeWidth="2" transform="rotate(-30 45 105)"/>
      <rect x="55" y="125" width="50" height="28" rx="4" fill="#8B4513" stroke="#654321" strokeWidth="2"/>
      <circle cx="80" cy="139" r="8" fill="#2d2d2d"/>
      <line x1="80" y1="115" x2="80" y2="125" stroke="#654321" strokeWidth="3"/>
  ...
  teaching: (
    <g className="animate-wiggle">
      ...
      {/* Pointing arm */}
      <line x1="80" y1="85" x2="120" y2="60" stroke="#46A302" strokeWidth="10" strokeLinecap="round"/>
      <circle cx="125" cy="58" r="8" fill="#58CC02" stroke="#46A302" strokeWidth="2"/>
      <rect x="55" y="125" width="50" height="28" rx="4" fill="#8B4513" stroke="#654321" strokeWidth="2"/>
      <circle cx="80" cy="139" r="8" fill="#2d2d2d"/>
      <line x1="80" y1="115" x2="80" y2="125" stroke="#654321" strokeWidth="3"/>
    </g>
...
export default function Bob({ pose = 'default', size = 200, className = '' }) {
  return (
    <svg
      ...
      aria-hidden
    >
      {BOB_POSES[pose] || BOB_POSES.default}
    </svg>
  );
}
